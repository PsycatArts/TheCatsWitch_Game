...
namespace DigitalRubyShared
{
    ...
    public class FingersImageGestureHelperComponentScript : ImageGestureRecognizerComponentScript
    {
        ...
        public DemoScriptImage demoscriptimage;
        ...
        {
            if (LineRenderers.Length != 0)                      //if a line exists
            {
                savedColor = LineRenderers[0].startColor;       //color it
        ...
        public ImageGestureImage CheckForImageMatch()
        {
            if (matchedImage == null)
            {
                if (MatchText != null)
                {
                    ...
                    MatchText.text = "Failed Grinding";
            ...
            else
            {
                if (MatchText != null)
                {
                    ...
                    MatchText.text = "Successfully grinded herbs" ;
                }
